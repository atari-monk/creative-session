...
var _AppHelper_instances, _AppHelper_pixiApp, _AppHelper_renderer, _AppHelper_canvas, _AppHelper_backgroundColor, _AppHelper_fullScreen, _AppHelper_width, _AppHelper_height, _AppHelper_gameObjects, _AppHelper_setCanvasStyles, _AppHelper_resizeCanvas;
...
_AppHelper_pixiApp = new WeakMap(), _AppHelper_renderer = new WeakMap(), _AppHelper_canvas = new WeakMap(), _AppHelper_backgroundColor = new WeakMap(), _AppHelper_fullScreen = new WeakMap(), _AppHelper_width = new WeakMap(), _AppHelper_height = new WeakMap(), _AppHelper_gameObjects = new WeakMap(), _AppHelper_instances = new WeakSet(), _AppHelper_setCanvasStyles = function _AppHelper_setCanvasStyles() {
