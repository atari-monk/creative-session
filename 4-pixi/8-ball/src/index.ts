...
import { ConnectErrorHandler } from '../../5-client/dist/ConnectErrorHandler.js';
...
import { DisconnectHandler } from '../../5-client/dist/DisconnectHandler.js';
...
playerSocketManager.addLogic(connectErrorHandler);
...
playerSocketManager.addLogic(disconnectHandler);
